 ...
 * 
 * @Configuration public class DefaultCircuitBreakerPropertiesConfiguration
 ...
 * = (CircuitBreakerProperties) bean; circuitBreakerProperties.getInstances()
 * .values() .stream() .filter(instanceProperties ->
 * Objects.isNull(instanceProperties.getBaseConfig()))
